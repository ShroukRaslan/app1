...
const Sidebar = () => {
  ...
  return (
   ...
   <div className="mobile-toggle d-md-none" onClick={toggleSidebar}>
    ...
    <Link cllinkssName="nav-link text-dark small" to="Home" onClick={closeSidebar}>HOME</Link>
 
  
    <Link className="nav-link text-dark small link" to="About"onClick={closeSidebar}>ABOUT</Link>
